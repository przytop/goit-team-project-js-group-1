import{a as N,t as q,M as A}from"./vendor-aedd9b60.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function o(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=o(s);fetch(s.href,a)}})();const M=document.querySelector(".theme-switcher"),b=document.documentElement;function D(){const e=b.getAttribute("data-theme")==="dark"?"light":"dark";b.setAttribute("data-theme",e),localStorage.setItem("theme",e),M.classList.toggle("active")}M.addEventListener("click",D);class h{constructor(){this.axios=N.create({baseURL:"https://api.themoviedb.org/3",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxOWZhNTk0Y2Q2ZWRlZDUxZGFlZTA0ODU0NjY1MjdkYiIsIm5iZiI6MTcyMjAzNzc3Mi41NzIxMDMsInN1YiI6IjY2YTE3MjQ1ZTE1OTc2ZWJmYWI4YmYzZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.G9xrsM-y8LQuvYrOh8SZI1olRXGF_yNK39ZipUP4QbY"}})}async _fetch(t,o={}){try{return(await this.axios.get(t,{params:o})).data}catch(n){throw console.error(`Failed to fetch ${t}: ${n.message}`),n}}async getTrendingMovies(t){if(!["day","week"].includes(t))throw new Error("Invalid time_window. Must be 'day' or 'week'");return(await this._fetch(`/trending/movie/${t}`)).results}async getTrendingMoviesTotal(t,o){if(!["day","week"].includes(t))throw new Error("Invalid time_window. Must be 'day' or 'week'");return await this._fetch(`/trending/movie/${t}`,{page:o})}async getUpcomingMovies(){return(await this._fetch("/movie/upcoming")).results}async searchMovie(t,o=1){return(await this._fetch("/search/movie",{query:t,page:o})).results}async searchMovieTotal(t,o=1){return await this._fetch("/search/movie",{query:t,page:o})}async getMovieDetails(t){return await this._fetch(`/movie/${t}`)}async getMovieVideos(t){return(await this._fetch(`/movie/${t}/videos`)).results}async getMovieGenres(){return(await this._fetch("/genre/movie/list")).genres}async getCountriesList(){return await this._fetch("/configuration/countries")}}new h;window.addEventListener("scroll",q(function(){const e=document.getElementById("scrollUpBtn");window.scrollY>50?e.style.display="block":e.style.display="none"},100));document.getElementById("scrollUpBtn").addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"})});class k{constructor(t){this.localStorageKey=t,this.movies=JSON.parse(localStorage.getItem(this.localStorageKey))||[]}_saveData(){try{localStorage.setItem(this.localStorageKey,JSON.stringify(this.movies))}catch(t){console.error("Error saving data:",t)}}addMovie(t){this.movies.findIndex(n=>n.id===t.id)===-1?(this.movies.push(t),this._saveData()):console.log("Movie already added:",t)}removeMovie(t){const o=this.movies.findIndex(n=>n.id===t);o!==-1?(this.movies.splice(o,1),this._saveData()):console.log("Movie not found")}getMovies(){return this.movies}}new k("local-movies");const u=document.querySelector(".backdrop"),Y=document.querySelector(".modal-btn-open");function E(e){u.classList.remove("is-closed"),j(e)}function w(){u.classList.add("is-closed"),u.innerHTML=""}async function j(e){const t=new h,o=new k("myLibrary"),n=document.querySelector(".backdrop");try{const{title:s,poster_path:a,vote_average:r,vote_count:v,popularity:y,genres:C,overview:p}=await t.getMovieDetails(e),g=C.map(d=>d.name).join(" ");n.innerHTML=`
    ...
    `,document.querySelector(".modal-btn-close").addEventListener("click",w),document.addEventListener("keydown",function(d){d.key==="Escape"&&w()}),document.getElementById("library-actions-btn").addEventListener("click",()=>{o.addMovie({id:e,title:s,poster_path:a,vote_average:r,vote_count:v,popularity:y,genreNames:g,overview:p})})}catch(s){console.error("Error fetching movie details:",s)}}Y.addEventListener("click",()=>E(573435));const Z=document.getElementById("our-team-btn"),c=document.querySelector(".team"),I=document.querySelector(".team-close-btn"),B=document.querySelector("body");Z.addEventListener("click",J);function J(e){e.preventDefault(),c.classList.remove("is-closed"),document.body.classList.add("modal-open"),U()}function S(e){e.preventDefault(),e.code==="Escape"&&f()}function x(e){e.target.closest(".team-window")||f()}function T(e){e.preventDefault(),f()}function U(){document.addEventListener("keydown",S),c.addEventListener("click",x),I.addEventListener("click",T),B.style.overflow="hidden"}function f(){document.removeEventListener("keydown",S),c.removeEventListener("click",x),I.removeEventListener("click",T),c.classList.add("is-closed"),document.body.classList.remove("modal-open"),B.style.overflow="auto"}const $=new h,W=e=>{const t=document.getElementById("hero-section"),o=document.querySelector(".hero-text-cont");o.innerHTML=`
  ...
  `;const n=`https://image.tmdb.org/t/p/original${e.backdrop_path}`;t.style.backgroundImage=`linear-gradient(270deg, rgba(89, 130, 252, 0) 5%, rgba(0, 0, 0, 1) 70%), url(${n})`,t.style.backgroundPosition="center",document.querySelector(".watch-btn").addEventListener("click",()=>G(e.id)),document.querySelector(".details-btn").addEventListener("click",()=>E(e.id))},z=e=>{const t=Math.round(e*10)/10,o=5,n=Math.floor(t/2),s=t%2>=1?1:0,a=o-n-s;return`<span>${[...Array(n).fill('<svg class="star full"><use xlink:href="#icon-star"></use></svg>'),...Array(s).fill('<svg class="star half"><use xlink:href="#icon-star-half"></use></svg>'),...Array(a).fill('<svg class="star empty"><use xlink:href="#icon-star-outline"></use></svg>')].join("")}</span>`},G=async e=>{try{const o=(await $.getMovieVideos(e)).find(n=>n.type==="Trailer");o?new A(".watch-btn",{channel:"youtube",autoplay:1,url:`https://www.youtube.com/watch?v=${o.key}`}).open():window.alert("Trailer not available")}catch(t){console.error("Failed to load movie videos:",t),H()}};let m=!1;const H=()=>{if(m)return;m=!0;const e=document.getElementById("hero-section"),t=document.createElement("div");t.className="modal-oopsie fade-in",t.id="modal-cont",e.appendChild(t);const o=document.getElementById("modal-cont");o.innerHTML=`
...
//# sourceMappingURL=main-a40ed558.js.map
