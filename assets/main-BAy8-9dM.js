import{a as T,t as O,i as g,M as $}from"./vendor-CQEYNoGD.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=o(n);fetch(n.href,a)}})();const w=document.querySelector(".theme-switcher"),p=document.documentElement;function C(){const e=p.getAttribute("data-theme")==="dark"?"light":"dark";p.setAttribute("data-theme",e),localStorage.setItem("theme",e),w.classList.toggle("active")}w.addEventListener("click",C);class f{constructor(){this.axios=T.create({baseURL:"https://api.themoviedb.org/3",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxOWZhNTk0Y2Q2ZWRlZDUxZGFlZTA0ODU0NjY1MjdkYiIsIm5iZiI6MTcyMjAzNzc3Mi41NzIxMDMsInN1YiI6IjY2YTE3MjQ1ZTE1OTc2ZWJmYWI4YmYzZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.G9xrsM-y8LQuvYrOh8SZI1olRXGF_yNK39ZipUP4QbY"}})}async _fetch(t,o={}){try{return(await this.axios.get(t,{params:o})).data}catch(s){throw console.error(`Failed to fetch ${t}: ${s.message}`),s}}async getTrendingMovies(t){if(!["day","week"].includes(t))throw new Error("Invalid time_window. Must be 'day' or 'week'");return(await this._fetch(`/trending/movie/${t}`)).results}async getTrendingMoviesTotal(t,o){if(!["day","week"].includes(t))throw new Error("Invalid time_window. Must be 'day' or 'week'");return await this._fetch(`/trending/movie/${t}`,{page:o})}async getUpcomingMovies(){return(await this._fetch("/movie/upcoming")).results}async searchMovie(t,o=1){return(await this._fetch("/search/movie",{query:t,page:o})).results}async searchMovieTotal(t,o=1){return await this._fetch("/search/movie",{query:t,page:o})}async getMovieDetails(t){return await this._fetch(`/movie/${t}`)}async getMovieVideos(t){return(await this._fetch(`/movie/${t}/videos`)).results}async getMovieGenres(){return(await this._fetch("/genre/movie/list")).genres}async getCountriesList(){return await this._fetch("/configuration/countries")}}new f;window.addEventListener("scroll",O(function(){const e=document.getElementById("scrollUpBtn");window.scrollY>50?e.style.display="block":e.style.display="none"},100));document.getElementById("scrollUpBtn").addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"})});class y{constructor(t){this.localStorageKey=t,this.movies=JSON.parse(localStorage.getItem(this.localStorageKey))||[]}_saveData(){try{localStorage.setItem(this.localStorageKey,JSON.stringify(this.movies))}catch(t){console.error("Error saving data:",t)}}addMovie(t){this.movies.findIndex(s=>s.id===t.id)===-1?(this.movies.push(t),this._saveData()):console.log("Movie already added:",t)}removeMovie(t){const o=this.movies.findIndex(s=>s.id===t);o!==-1?(this.movies.splice(o,1),this._saveData()):console.log("Movie not found")}getMovies(){return this.movies}}new y("local-movies");const c=document.querySelector(".backdrop");function _(e){c.classList.remove("is-closed"),A(e),document.body.style.overflow="hidden"}function m(){c.classList.add("is-closed"),c.innerHTML="",document.body.style.overflow="auto"}async function A(e){const t=new f;try{const o=await t.getMovieDetails(e),s=o.genres.map(i=>i.name).join(" ");c.innerHTML=`
    ...
    `,document.querySelector(".modal-btn-close").addEventListener("click",m),document.addEventListener("keydown",function(i){i.key==="Escape"&&m()}),c.addEventListener("click",function(i){i.target.closest(".modal-window")||m()});const a=document.getElementById("library-actions-btn");h(o.id),a.addEventListener("click",()=>{D(o),h(o.id)})}catch(o){console.error("Error fetching movie details:",o)}}function D(e){const t=new y("myLibrary"),o=t.getMovies().some(s=>s.id===e.id);if(!e.id){console.error("Movie ID is undefined:",e);return}o?(t.removeMovie(e.id),g.info({title:"Info",message:"Removed from my library",backgroundColor:"red",messageSize:"13",closeOnEscape:!0,closeOnClick:!0})):(t.addMovie(e),g.success({title:"Success ",message:"Added to my library",backgroundColor:"orange",messageSize:"13",closeOnEscape:!0,closeOnClick:!0})),h(e.id)}function h(e){const o=new y("myLibrary").getMovies().some(n=>n.id===e),s=document.getElementById("library-actions-btn");o?s.textContent="Remove from my library":s.textContent="Add to my library"}const N=document.getElementById("our-team-btn"),l=document.querySelector(".team"),L=document.querySelector(".team-close-btn"),k=document.querySelector("body");N.addEventListener("click",Y);function Y(e){e.preventDefault(),l.classList.remove("is-closed"),document.body.classList.add("modal-open"),j()}function M(e){e.preventDefault(),e.code==="Escape"&&v()}function E(e){e.target.closest(".team-window")||v()}function I(e){e.preventDefault(),v()}function j(){document.addEventListener("keydown",M),l.addEventListener("click",E),L.addEventListener("click",I),k.style.overflow="hidden"}function v(){document.removeEventListener("keydown",M),l.removeEventListener("click",E),L.removeEventListener("click",I),l.classList.add("is-closed"),document.body.classList.remove("modal-open"),k.style.overflow="auto"}const x=new f,q=e=>{const t=document.getElementById("hero-section"),o=document.querySelector(".hero-text-cont");o.innerHTML=`
