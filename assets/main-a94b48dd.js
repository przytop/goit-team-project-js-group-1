import{a as C,t as D,M as N}from"./vendor-aedd9b60.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function o(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=o(s);fetch(s.href,a)}})();const M=document.querySelector(".theme-switcher"),b=document.documentElement;function Y(){const e=b.getAttribute("data-theme")==="dark"?"light":"dark";b.setAttribute("data-theme",e),localStorage.setItem("theme",e),M.classList.toggle("active")}M.addEventListener("click",Y);class h{constructor(){this.axios=C.create({baseURL:"https://api.themoviedb.org/3",headers:{accept:"application/json",Authorization:`Bearer ${{}.VITE_API_KEY}`,Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxOWZhNTk0Y2Q2ZWRlZDUxZGFlZTA0ODU0NjY1MjdkYiIsIm5iZiI6MTcyMjAzNzc3Mi41NzIxMDMsInN1YiI6IjY2YTE3MjQ1ZTE1OTc2ZWJmYWI4YmYzZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.G9xrsM-y8LQuvYrOh8SZI1olRXGF_yNK39ZipUP4QbY"}})}async _fetch(t,o={}){try{return(await this.axios.get(t,{params:o})).data}catch(n){throw console.error(`Failed to fetch ${t}: ${n.message}`),n}}async getTrendingMovies(t){if(!["day","week"].includes(t))throw new Error("Invalid time_window. Must be 'day' or 'week'");return(await this._fetch(`/trending/movie/${t}`)).results}async getUpcomingMovies(){return(await this._fetch("/movie/upcoming")).results}async searchMovie(t,o=1){return(await this._fetch("/search/movie",{query:t,page:o})).results}async getMovieDetails(t){return await this._fetch(`/movie/${t}`)}async getMovieVideos(t){return(await this._fetch(`/movie/${t}/videos`)).results}async getMovieGenres(){return(await this._fetch("/genre/movie/list")).genres}async getCountriesList(){return await this._fetch("/configuration/countries")}}new h;window.addEventListener("scroll",D(function(){const e=document.getElementById("scrollUpBtn");window.scrollY>50?e.style.display="block":e.style.display="none"},100));document.getElementById("scrollUpBtn").addEventListener("click",function(){window.scrollTo({top:0,behavior:"smooth"})});class k{constructor(t){this.localStorageKey=t,this.movies=JSON.parse(localStorage.getItem(this.localStorageKey))||[]}_saveData(){try{localStorage.setItem(this.localStorageKey,JSON.stringify(this.movies))}catch(t){console.error("Error saving data:",t)}}addMovie(t){this.movies.findIndex(n=>n.id===t.id)===-1?(this.movies.push(t),this._saveData()):console.log("Movie already added:",t)}removeMovie(t){const o=this.movies.findIndex(n=>n.id===t);o!==-1?(this.movies.splice(o,1),this._saveData()):console.log("Movie not found")}getMovies(){return this.movies}}new k("local-movies");const u=document.querySelector(".backdrop"),q=document.querySelector(".modal-btn-open");function A(e){u.classList.remove("is-closed"),Z(e)}function w(){u.classList.add("is-closed"),u.innerHTML=""}async function Z(e){const t=new h,o=new k("myLibrary"),n=document.querySelector(".backdrop");try{const{title:s,poster_path:a,vote_average:i,vote_count:v,popularity:y,genres:_,overview:p}=await t.getMovieDetails(e),g=_.map(d=>d.name).join(" ");n.innerHTML=`
    ...
    `,document.querySelector(".modal-btn-close").addEventListener("click",w),document.addEventListener("keydown",function(d){d.key==="Escape"&&w()}),document.getElementById("library-actions-btn").addEventListener("click",()=>{o.addMovie({id:e,title:s,poster_path:a,vote_average:i,vote_count:v,popularity:y,genreNames:g,overview:p})})}catch(s){console.error("Error fetching movie details:",s)}}q.addEventListener("click",()=>A(573435));const j=document.getElementById("our-team-btn"),r=document.querySelector(".team"),E=document.querySelector(".team-close-btn"),I=document.querySelector("body");j.addEventListener("click",J);function J(e){e.preventDefault(),r.classList.remove("is-closed"),document.body.classList.add("modal-open"),U()}function B(e){e.preventDefault(),e.code==="Escape"&&f()}function T(e){e.target.closest(".team-window")||f()}function S(e){e.preventDefault(),f()}function U(){document.addEventListener("keydown",B),r.addEventListener("click",T),E.addEventListener("click",S),I.style.overflow="hidden"}function f(){document.removeEventListener("keydown",B),r.removeEventListener("click",T),E.removeEventListener("click",S),r.classList.add("is-closed"),document.body.classList.remove("modal-open"),I.style.overflow="auto"}const x=new h,z=e=>{const t=document.getElementById("hero-section"),o=document.querySelector(".hero-text-cont");o.innerHTML=`
